...
print(insert_video(conn, cursor, video_uuid,"Sample Video"))
print(insert_model(conn, cursor, model_uuid, "Sample Model", "https://model.com"))
print(insert_frame(conn, cursor, frame_uuid, video_uuid, 1, b"image bytes"))
...
print(get_frame_list(conn, cursor, video_uuid, model_uuid))
